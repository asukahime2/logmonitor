...
public class MainTest {
    ...
    @Test
    public void test_doProcess_第三引数_数値以外() {
        // 3要素目が存在しない行がある
        final String invalidFormatFileName = "test/resources/invalid_monitoring_3_1.log";
    ...
    @Test
    public void test_doProcess_第四引数_数値以外() {
        // 3要素目が存在しない行がある
        final String invalidFormatFileName = "test/resources/invalid_monitoring_3_1.log";
    ...
    @Test
    public void test_doProcess_正常_過負荷状態出力() {
        ...
        Main.main(args);
        assertEquals("IP : 1.1.1.1/24, SECONDS_TO_RETURN : 20\r\n"
                + "IP : 1.1.1.2/24, OVERLOAD_PERIOD : 20210717101010-20210717101030\r\n"
                , out.toString());
    }

    @Test
    public void test_doProcess_正常_過負荷状態出力_複数() {
        ...
        Main.main(args);
        assertEquals("IP : 1.1.1.1/24, SECONDS_TO_RETURN : 20\r\n"
                + "IP : 1.1.1.2/24, OVERLOAD_PERIOD : 20210717101010-20210717101020\r\n"
                + "IP : 1.1.1.2/24, OVERLOAD_PERIOD : 20210717101040-20210717101050\r\n"
                , out.toString());
    }
